...
void Camera::updateViewMatrix()
{
	...
	view_matrix.setIdentity();
	view_matrix.M[0][0] = side.x; 	view_matrix.M[0][1] = top.x; view_matrix.M[0][2] = -front.x;  view_matrix.M[0][3] = 0;
	view_matrix.M[1][0] = side.y; 	view_matrix.M[1][1] = top.y; view_matrix.M[1][2] = -front.y;  view_matrix.M[1][3] =0;
	view_matrix.M[2][0] = side.z; 	view_matrix.M[2][1] = top.z; view_matrix.M[2][2] = -front.z;  view_matrix.M[2][3] = 0;
	view_matrix.M[3][0] = 0.0; 	view_matrix.M[3][1] = 0; view_matrix.M[3][2] = 0;  view_matrix.M[3][3] = 1;
...
void Camera::updateProjectionMatrix()
{
	...
	float M_22 = (this->far_plane + this->near_plane) / (this->near_plane - this->far_plane);
	float M_32 = 2*(this->far_plane * this->near_plane) / (this->near_plane - this->far_plane);
	...
	projection_matrix.M[2][0] = 0.0; 	projection_matrix.M[2][1] = 0.0; projection_matrix.M[2][2] = M_22; projection_matrix.M[2][3] = -1;
	projection_matrix.M[3][0] = 0.0; 	projection_matrix.M[3][1] = 0.0; projection_matrix.M[3][2] = M_32;  projection_matrix.M[3][3] = 0.0;
